...
<div id="page">
	...
	<div id="content">
		...
		<%
		try{
		ResultSet rs=st.executeQuery("select * from vendorstock v,item i where v.itid=i.itid");
		%>
		<table width="897" height="60" border="1" cellspacing="3">
		<tr> <td width="106"> Serial Number</td>
		<td width="509">Item name</td>
		<td width="509">Quantity</td>
		<td width="509">Price</td>
		<td width="118">Availability</td>
		...
		<td><a href="vstockedit.jsp?a1=<%=rs.getString(1)%>">Edit</a></td>
		</tr>
		<% } %>
		</table>
		<%
