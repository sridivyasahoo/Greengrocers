...
String s1="";
  try{		
	...
	if(rs.next()){  %>
		<img src="./images/item/<%=rs.getString("photo1")%>" width="300" height="200" alt="no imsgeds" /> 
		<img src="./images/item/<%=rs.getString("photo2")%>" width="300" height="200" alt="no imsgeds" />
		<img src="./images/item/<%=rs.getString("photo3")%>" width="300" height="200" alt="no imsgeds" /><br /> 
<%	}
...
<form enctype="multipart/form-data" action="UploadServlet4" method="post"> 
<input type="hidden" name="a1" value="<%=s1%>" />
<table border="0" bgcolor="#FF3300">
	<tr>
