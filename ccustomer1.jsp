...
<div id="page">
	...
	<div id="content">
		<div class="post">
			<h1 class="title">Welcome <%= session.getAttribute("name") %> to Details</a></h1>
		</div>
		<%
		...
		if(rs.next()){
			String qry1="update customer set name='"+s2+"',dob='"+s3+"',faname='"+s4+"',gender='"+s5+"',phn='"+s6+"',mail='"+s7+"',addr='"+s8+"' where uid='"+s1+"'";
