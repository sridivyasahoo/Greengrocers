...
<div id="page">
	...
	<div id="content">
		...
		try{
		ResultSet rs=st.executeQuery("select * from vendorstock where vsid='"+s1+"'");
		if(rs.next()){
			String qry1="update vendorstock set Qty='"+s2+"',price='"+s3+"',available='"+s4+"'";
			int z=st.executeUpdate(qry1);
			if(z>0)
			out.print("<font color=green size=3>Stock Updated Successfully</font>");
		}
		con.close();
  }catch(Exception e){ 
    out.print(e);
